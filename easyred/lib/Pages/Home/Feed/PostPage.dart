        ...
        children: [
                ...
                children: [
                  ...
                  imagePost != null
                      ? Container(
                          ...
                          child: FadeInImage(
                            placeholder:
                                AssetImage('assets/images/giflodingPost.gif'),
          ...
          Card(
            ...
            shape: RoundedRectangleBorder(
                ...
                side: BorderSide(
                    color: Colors.grey[200] ?? Colors.transparent, width: 2)),
            child: Container(
              width: MediaQuery.of(context).size.width,
                                ...
                                if (imagePost != null) {
                                  Provider.of<FirebasePost>(context,
                                    ...
                                    Provider.of<FirebasePost>(context,
                                            listen: false)
                                        .createPost(context, {
                                      "username": Provider.of<FirebaseUtils>(
                                              context,
                                              listen: false)
                                          .initUsername,
                                      "userUid":
                                      ...
                                      "time": DateTime.now(),
                                      "postImageUrl": Provider.of<FirebasePost>(
                                              context,
                                              listen: false)
                                          .postImageUrl
                                    }).whenComplete(() {
